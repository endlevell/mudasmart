...
// Profil murid — identitas, detail akun, dan akses riwayat.
    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: spacing.xxl }}>
      <LinearGradient colors={['#073D2C', '#0B6E4F']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={[styles.hero, { paddingTop: insets.top + spacing.lg }]}>
        ...
        <View style={styles.rolePill}>
          ...
          <Text style={styles.rolePillText}>Murid</Text>
        </View>
      </LinearGradient>
        ...
        <Animated.View entering={FadeInDown.delay(40)}>
          <Card>
            ...
            <View style={{ marginTop: spacing.sm }}>
              ...
              <InfoRow icon="school-outline" label="Role" value="Murid" />
            </View>
          </Card>
        </Animated.View>
          ...
          <Card>
            ...
            <View style={{ marginTop: spacing.xs }}>
              <MenuItem
                ...
                onPress={() => router.navigate('/(murid)/riwayat')}
              />
              <MenuItem
